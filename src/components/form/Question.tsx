    ...
    return (
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="flex w-full flex-col gap-10">
                    ...
                    render={({ field }) => (
                        <FormItem className="flex w-full flex-col">
                            ...
                            <FormControl className="mt-3.5">
                                <Input className="no-focus paragraph-regular background-light900_dark300 light-border-2 text-dark300_light700 min-h-[56px] border" placeholder="start writing here" {...field} />
                            </FormControl>
                            <FormDescription className="body-regular mt-2.5 text-light-500">
                                Be specific and imagine you&lsquo;re asking a question to another person.
                            </FormDescription>
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem className="flex w-full flex-col gap-3">
                            ...
                            <FormDescription className="body-regular mt-2.5 text-light-500">
                                Introduce the problem and expand on what you put in the title. Minimum 20 chracters.
                            </FormDescription>
                            <FormMessage className="text-red-600" />
                        </FormItem>
                    )}
                ...
                />
                <Button className="primary-gradient mb-5 w-fit !text-light-900"
                    type="submit"
